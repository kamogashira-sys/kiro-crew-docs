...
> ⚠️ 一次情報の固定参照時点は**2026-08-22**です。Kiro Crewの固定コミットは`21584ea`（v0.3.0タグ）、この時点の最新安定版は`v0.3.0`です。以後のKiro Crewの更新は、反映されるまで本サイトには含まれません。
...
|------|------|
| 固定参照日 | 2026-08-22 |
| Kiro Crew固定コミット | `21584eabce653b4f40a412aaad25e3489e47e84b`（`v0.3.0`タグ） |
| 固定時点の最新安定版 | `v0.3.0` |
| 更新履歴の対象 | 安定版 `v0.1.0`〜`v0.3.0` |
